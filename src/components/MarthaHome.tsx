...
const specialtyServices = [
  ["02", "Sports massage", "Masaje deportivo", "https://marthashealingtouch.com/services/sports-massage/"],
  ["03", "Prenatal massage", "Masaje prenatal", "https://marthashealingtouch.com/services/prenatal-massage/"],
  ["04", "Post-operative drainage", "Drenaje postoperatorio", "https://marthashealingtouch.com/services/post-operatory-drainage/"],
  ["05", "Neuromuscular therapy", "Terapia neuromuscular", "https://marthashealingtouch.com/services/neuromuscular-therapy/"],
  ["06", "Microcurrent", "Microcorriente", "https://marthashealingtouch.com/services/microcurrent/"],
  ["07", "HydraFacial treatment", "Tratamiento HydraFacial", "https://marthashealingtouch.com/services/hydrafacial-treatment/"],
  ["08", "Healing Deep & Heat", "Healing Deep & Heat", "https://marthashealingtouch.com/services/healing-deep-heat/"],
  ["09", "Dermaplaning", "Dermaplaning", "https://marthashealingtouch.com/services/dermaplaning/"],
  ["10", "Deep tissue massage", "Masaje de tejido profundo", "https://marthashealingtouch.com/services/deep-tissue-massage/"],
] as const;
...
export function MarthaHome() {
  ...
  return <>
    <div className="mht-topbar">
      ...
      <div><a href={contact.instagram} target="_blank" rel="noreferrer">Instagram</a><a href={`https://wa.me/19546393226`} target="_blank" rel="noreferrer">WhatsApp</a></div>
    </div>
